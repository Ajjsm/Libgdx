...
public class Hud implements Disposable{
    ...
    public Hud(SpriteBatch sb){
        ...
        pausa = new Label("ESC: Pausar ", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        muteon = new Label("Mute: N/OFF M/ON ", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        //muteof = new Label("M: Mute OFF ", new Label.LabelStyle(new BitmapFont(), Color.WHITE));
        ...
        table.row();
        table.add(pausa).padTop(95);
        table.row();
        table.add(muteon).padTop(4);
        //table.add(muteof).padLeft(-60);
    ...
    private BitmapFont getFuenteIntroduccion(){
        ...
        parameter.size = (int)Math.ceil(18);
