...
public class GameOver implements Screen {
    ...
    public GameOver(Game game){
        ...
        Label gameOverLabel = new Label("¡ESTAS MUERTO", font);
        Label labelJugarOtra = new Label("Click para volver al menu principal", font);

        table.add(gameOverLabel).expandX();
        table.row();
        table.add(labelJugarOtra).expandX().padTop(10f);
